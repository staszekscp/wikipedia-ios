...
public class CommonStrings: NSObject {
    ...
    @objc public static let savedTabTitle = WMFLocalizedString("saved-title", value: "React Native", comment: "Title of the saved screen shown on the saved tab {{Identical|Saved}}")
